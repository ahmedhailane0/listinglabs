...
<header><h1>Binance Alpha → Perp → Coinbase → Korea — Listing Funnel</h1>
<nav class="topnav"><a href="../../report/index.html">Listing Reactions ({REACTIONS_N})</a><a class="active" href="index.html">Listing Funnel ({len(M)})</a><a href="../../scams/index.html">Scam Watchlist</a></nav>
